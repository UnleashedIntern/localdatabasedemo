    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[student] SET [Id] = @Id, [name] = @name WHERE (([Id] = @Original_Id" +
                ...
                "LECT Id, name FROM student WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, name FROM dbo.student";
        ...
        public virtual int ShowAll(Database1DataSet.studentDataTable dataTable) {
